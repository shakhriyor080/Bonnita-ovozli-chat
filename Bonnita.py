...
opts = {
    "alias": ('Bonnita' , 'bonita', 'banita', 'bonita', 'bon', 'vonita',
              'donita', '', 'bonita', 'bonita', 'banita'),
...
def execute_cmd(cmd):
    if cmd == 'ctime':
        ...
        # Yemagan xazil
        speak("ha bilaman karam cho'milishga borip cho'kip o'lipdi xa xa xa")
...
speak("Xammaga salom")
speak("Men 'Bonnita' suniy intelekt bulaman hozirgi vaqt va latifa ayta olaman ")
